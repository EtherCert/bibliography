        ...
        <div class="kt-portlet">
          <div class="kt-portlet__head">
            ...
            <div class="kt-portlet__head-toolbar" style="margin-top: 7px;">
                <a style="font-size: 70%;" href="{{route('admin.studies.excel.scientific',['study_state' => $study_state])}}" class="btn btn-outline-info" class="popupFormBtn btn btn-success">
                <i class="fa fa-file-excel"></i>&nbsp;إكسل الدراسات العلمية
                </a><a style="font-size: 70%; margin-right: 5px;" href="{{route('admin.studies.excel.state',['study_state' => $study_state])}}" class="btn btn-outline-success" class="popupFormBtn btn btn-success">
                          ...
                          <div class="kt-widget2__actions">
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right" x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(15px, 5px, 0px);">
                              <ul class="kt-nav">
                                ...
                                <li class="kt-nav__item" style="float: center;">
                                  <a href="{{route('admin.study.download-summary-ar', ['id' => $study->id])}}" class="kt-nav__link"> 
                                  <i class="kt-nav__link-icon fa fa-download"></i>
                                  <span class="kt-nav__link-text">ملخص الدراسة</span>
                                  </a>
                                </li>
                                <li class="kt-nav__item" style="float: center;">
                                  <a href="{{route('admin.study.download-study', ['id' => $study->id])}}" class="kt-nav__link"> 
                                  <i class="kt-nav__link-icon fa fa-download"></i>
