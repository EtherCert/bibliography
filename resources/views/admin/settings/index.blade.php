          ...
          <div class="kt-portlet__body">
            ...
            <div class="kt-widget4">
              ...
              <div class="kt-widget4__item">
                ...
                <span>
                <a href="{{asset('storage/'.$settings->logo)}}"><img class="img-thumbnail img-responsive" alt="attachment" style="width:170px; height:100px;" src="{{asset('storage/'.$settings->logo)}}"></a>
                </span> 
                <span class="kt-widget4__icon">
              ...
              <div class="kt-widget4__item">
                ...
                <span>
                <a href="{{asset($settings->seal)}}"><img class="img-thumbnail img-responsive" alt="attachment" style="width:170px; height:100px;" src="{{asset('storage/'.$settings->seal)}}"></a>
                </span>
                <span class="kt-widget4__icon">
