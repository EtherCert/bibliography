   ...
   <body style="font-family: 'Droid Arabic Kufi', serif;" class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
      ...
      <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
         <div class="kt-header-mobile__logo">
            <a href="/">
            <img alt="Logo" src="{{asset('storage/logos/logo1.png')}}" />
            </a>
         </div>
      ...
      <div class="kt-grid kt-grid--hor kt-grid--root">
         <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
            ...
            <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
               ...
               <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                ...
                @foreach($links as $link)
                    ...
                    ?> 
                        <li  class="kt-menu__item  kt-menu__item--submenu {{ strstr('/'.Route::getFacadeRoot()->current()->uri(),$preventeroor->first()?$preventeroor->first()->link:"")? 'kt-menu__item--open':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                           <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                           <span class="kt-menu__link-icon">
                           <i class="kt-menu__link-icon {{$link->icon}}"></i>
                           </span>
                           <span class="kt-menu__link-text">{{$link->title}}</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
                           </a>
                           <div class="kt-menu__submenu {{ strstr('/'.Route::getFacadeRoot()->current()->uri(),$preventeroor->first()?$preventeroor->first()->link:"")? 'kt-menu__item--open':'' }}">
                              <span class="kt-menu__arrow"></span>
                              <ul class="kt-menu__subnav">
                                @foreach($sub_links as $sub_link)
                                 <li class="kt-menu__item  kt-menu__item--submenu {{ strstr('/'.Route::getFacadeRoot()->current()->uri(),$sub_link->link?$sub_link->link:"")? 'kt-menu__item--open':'' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="/{{$sub_link->link}}" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">{{$sub_link->title}}</span></a>
                                 </li>
                                @endforeach
                              </ul>
                           </div>
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                  ...
                  <div class="kt-header__topbar">
                           ...
                           <form>
                              ...
                              <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url({{asset('assets/media/misc/bg-1.jpg')}}">
                                 ...
                                 <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x" role="tablist">
                                    ...
                                    <li class="nav-item">
                                       <a class="nav-link" href="{{route('admin.notifications.index')}}" role="tab" aria-selected="false">عرض الكل</a>
                                    </li>
                                 </ul>
                              </div>
                              <!--end: Head -->
                     ...
                     <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(5px, 49px, 0px);">
                           <a class="dropdown-item text-center" href="{{route('admin.profile')}}">
                           الاعدادات
                           </a>
                           <li>
               ...
               @if(count($errors)>0)
               <br>
               <div class="alert alert-danger  col-md-12" style="padding: 0 !important;;" role="alert">
